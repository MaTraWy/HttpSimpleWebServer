...
<html>
        ...
        <body>
			...
			<div class="slider">
			<img src="../sss/images/2.jpg" />
			<div class="just_text">Future is here..</div>
			<img src="../sss/images/3.jpg" />
			<div><img src="../sss/images/4.jpg" /><span class="caption">science is science</span></div>
			
			</div>
			<div class="txt">
                     <h1>Welcome to the Faculty of Science</h1> <p>The Faculty of Science at Alexandria University is poised to be a leading institution in education and research as well as a national and international center of excellence (Faculty Vision).
...
</p><p>Prof. Mohamed Ismail Ibrahim - Dean of the Faculty of Science</p>
           </div>
		   </div>
        </body>
</html>